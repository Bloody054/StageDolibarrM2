...
class modConnect extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 446143;		// TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		...
		// Module label (no space allowed), used if translation string 'ModuleconnectName' not found (MyModue is name of module).
		$this->name = preg_replace('/^mod/i','',get_class($this));
		// Module description, used if translation string 'ModuleconnectDesc' not found (MyModue is name of module).
		$this->description = "Connect";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "Module permettant d'ajouter des fonctionnalités à l'api REST de Dolibarr";
		...
		$this->picto='connect@connect';

		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /connect/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /connect/core/modules/barcode)
		// for specific css file (eg: /connect/css/connect.css.php)
		...
		if (! isset($conf->connect) || ! isset($conf->connect->enabled))
        {
        ...
        // Boxes/Widgets
		// Add here list of php file(s) stored in connect/core/boxes that contains class to show a widget.
        $this->boxes = array();
