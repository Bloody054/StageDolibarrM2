...
/**
 *    	\file       htdocs/core/modules/questionnaire/mod_questionnaire_marbre.php
 ...
 */
class mod_questionnaire_vittel extends ModeleNumRefQuestionnaires
{
	...
	/**
	 *  Rquestionnaire la description du modele de numerotation
	 *
	...
	function canBeActivated()
	{
		...
		$sql.= " FROM ".MAIN_DB_PREFIX."questionnaire";
	 ...
	 * @param   Questionnaire		$questionnaire	Object slice
	...
	function getNextValue($objsoc,$questionnaire,$mode='next')
	{
		...
		$sql.= " AND entity IN (".getEntity('questionnaire').")";
	 ...
	 *
     * @param	Societe		$objsoc     	Object third party
     * @param	Questionnaire		$objforref		Object for number to search
     * @param   string		$mode       	'next' for next value or 'last' for last value
