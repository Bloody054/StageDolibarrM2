...
$(document).ready(function() {
    $('#<?php echo $line->code; ?>').select2({
        width: 'resolve'
                        ...
                        <?php
                        print $formproject->select_projects_list(-1, $val, $line->code, 64, 0, 1, 0, 0, 0, 0, '', 0, 0, '', '', 1);
                        
                        //I prefer this but no autocomplete on web interface...Search for todo → print $form->form_project($_SERVER['PHP_SELF'].'?id='.$object->id, -1, $val, $line->code, 0, 1, 0, 1, '', 'maxwidth300');
