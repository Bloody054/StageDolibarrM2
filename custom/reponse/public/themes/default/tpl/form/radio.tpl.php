	...
	<div class="container">
		<div class="row justify-content-center align-items-center">
			<div class="col-10 col-md-10 col-lg-8 text-center">
                ...
                <form id="report" name="report" action="/custom/reponse/public/report.php" method="post">
                        ...
                        <?php if (count($options)): ?>
                            <?php foreach ($options as $val => $label): ?>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="<?php echo $val; ?>" name="<?php echo $line->code; ?>" id="check-<?php echo $val; ?>" <?php echo (in_array($val, $values) ? 'checked' : ''); ?>>
