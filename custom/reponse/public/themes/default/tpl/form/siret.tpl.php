			...
			<div class="col-10 col-md-10 col-lg-8 text-center">
                ...
                <form id="report" name="report" action="<?php echo $site->makeUrl('report.php'); ?>" method="post">
                    ...
                    <div class="form-group mb-5">
                        <input class="form-control" name="<?php echo $line->code; ?>" id="question" placeholder="" type="text" aria-label="<?php echo $line->code; ?>" value="<?php echo $line->value; ?>" <?php echo $line->mandatory ? 'required' : '' ?>>
                    </div>
