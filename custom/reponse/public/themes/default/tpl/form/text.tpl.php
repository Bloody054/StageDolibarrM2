			...
			<div class="col-10 col-md-10 col-lg-8 text-center">
                ...
                <form id="report" name="report" action="<?php echo $site->makeUrl('report.php'); ?>" method="post">
                    ...
                    <div class="form-group mb-5">
                        <textarea class="form-control" name="<?php echo $line->code; ?>" id="question" placeholder="" rows="4" aria-label="<?php echo $line->code; ?>" <?php echo $line->mandatory ? 'required' : '' ?>><?php echo $line->value; ?></textarea>
                    </div>
